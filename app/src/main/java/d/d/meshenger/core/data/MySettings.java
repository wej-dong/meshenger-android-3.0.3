...
public class MySettings {
    ...
    public static MySettings importJSON(JSONObject obj) throws JSONException {
    ...
    public static JSONObject exportJSON(MySettings s) throws JSONException {
